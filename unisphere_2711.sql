...
--
-- Host: localhost:3306
-- Generation Time: Nov 27, 2024 at 01:38 PM
...
(9, '2024-11-27 13:10:19', 'test', 1, 10),
(10, '2024-11-27 13:17:11', 'ok', 2, 2),
(11, '2024-11-27 13:59:58', 'test', 1, 11),
(12, '2024-11-27 14:01:05', 'test', 1, 2),
(13, '2024-11-27 14:01:17', 'test', 2, 3),
(14, '2024-11-27 14:21:27', 'J\'ai l\'erreur 404', 3, 13);
...
(10, '2024-11-27 12:10:16', 'test', 'aaa', 'fermé', 1, 5),
(11, '2024-11-27 12:11:06', 'PC HS', 'PC HS', 'ouvert', 2, 1),
(12, '2024-11-27 13:00:41', 'sa marches pa', 'ollolo', 'ouvert', 1, 2),
(13, '2024-11-27 13:21:06', 'Connexion au lobby', 'Je ne peux pas me connecter', 'ouvert', 3, 2);
...
(1, 'Guerrand', 'Anthony', 'iris', 'anthony.guerrand92@gmail.com', 'root', 3),
(2, 'LOL', 'Alex', 'iris', 'fqf@gmail.com', 'root', 1),
(3, 'Pito', 'Jean', 'epita', 'jp@free.fr', 'root', 1);
...
--
ALTER TABLE `pol_reponse_ticket`
  MODIFY `id_reponse` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `pol_ticket`
--
ALTER TABLE `pol_ticket`
  MODIFY `id_ticket` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
